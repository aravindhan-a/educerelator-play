...
10. **Share loop v2** — v1 SHIPPED 2 Jul 2026 (image share cards: session score, streak milestones at 3/7/14/30/50/100/200/365 days, report card — child-safe: results only, never names). Next: per-language card text, achievement badges, "challenge a friend" deep links
